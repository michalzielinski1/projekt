...
public class ControllerEdit implements ActionListener {
    ...
    public ControllerEdit(JTable jTableSearch, DefaultTableModel model, ViewSearch view) {
        super();
        this.model = model;
        this.view = view;
